<html>
<?php
define("PAGE_TITLE", "Employee 01 Update");
...
if ($customerNumber == "") {
	if ((!$action) or ($action == "Continue")) {
		...
		/* Construct the SQL statement, using lastname as the search substring */
		$sql = 'CALL i5schema.CALLHSR200_TO_UPDATE_DATA (1, 12345678, FIL, 12345678) ';
	}
	...
	/* Construct the SQL statement, call stored procedure */
